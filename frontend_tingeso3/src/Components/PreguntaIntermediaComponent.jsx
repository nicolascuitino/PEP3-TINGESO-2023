...
class PreguntaIntermediaComponent extends Component {
    constructor(props) {
      super(props);
      this.state = {
        prueba: [],
    ...
    componentDidMount() {
        ...
        fetch("http://localhost:8080/pruebaService/post/intermedio")
    ...
    render() {
        return (
            ...
            <h1 className="text-center"> <b>Preguntas de dificultad intermedia</b></h1> 
            <body>
                <div className ="texto">
...
export default PreguntaIntermediaComponent;
